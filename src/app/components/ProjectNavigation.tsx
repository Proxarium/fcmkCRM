...
const ProjectNavigation = ({
  ...
  return (
    <motion.nav
      ...
      className={`h-full flex flex-col z-40 gap-8 w-64 absolute bg-neutral-900 ml-0 ${
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <NavigationLink href='/dashboard' name="Админ панель">
          <BoltIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink href='/dashboard/users' name="Пользователи">
          <UserGroupIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink href='/dashboard/brigade' name="Архив">
          <ArrowTrendingUpIcon
            href={href}
            className="stroke-[0.75] stroke-inherit min-w-8 w-8"
          />
        </NavigationLink>
        <NavigationLink href={href} name="Рецепты">
          <PencilIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink href={href} name="Up Next">
          <CursorArrowRaysIcon className="stroke-[0.75] stroke-inherit min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink href={href} name="Project Settings">
      ...
      <div className="flex flex-col gap-5">
        ...
        <a href={href} className="flex flex-row gap-3 place-items-center">
